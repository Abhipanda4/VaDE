...
def load_pretrain_weights(vade, ae, dataset):
...
ae.add(Dense(original_dim, activation='relu'))

ae.compile(optimizer='adam', loss='mse')
ae.fit(X, X, shuffle=True, nb_epoch=200, batch_size=batch_size)
...
if ispretrain == True:
    vade = load_pretrain_weights(vade, ae, dataset)
